...
const PHRASE_DATA = [
  ...
  { id: 111, category: '数字', thai: 'สิบเอ็ด', phonetic: 'Sip et', kana: 'スィップエット', meaning: '11', description: '1の位が1の時は「ヌン」ではなく「エット」になります。', breakdown: [] },
  { id: 112, category: '数字', thai: 'สิบสอง', phonetic: 'Sip song', kana: 'スィップソーン', meaning: '12', breakdown: [] },
  { id: 113, category: '数字', thai: 'ยี่สิบ', phonetic: 'Yi sip', kana: 'イースィップ', meaning: '20', description: '20は「ソーンスィップ」ではなく「イースィップ」。', breakdown: [] },
  ...
  { id: 224, category: '家族', thai: 'ลูก', phonetic: 'Look', kana: 'ルーク', meaning: '子供（自分の）', breakdown: [] },
  ...
  { id: 307, category: '疑問詞', thai: 'เท่าไหร่', phonetic: 'Thao rai', kana: 'タオライ', meaning: 'いくら/どれくらい？', breakdown: [] },
  { id: 308, category: '疑問詞', thai: 'กี่', phonetic: 'Kee', kana: 'ギー', meaning: 'いくつ（数）？', breakdown: [] },
  ...
  { id: 314, category: '疑問詞', thai: 'ไหม', phonetic: 'Mai', kana: 'マイ', meaning: '〜ですか？（Yes/No）', breakdown: [] },
  ...
  { id: 412, category: '動詞', thai: 'ทำ', phonetic: 'Tam', kana: 'タム', meaning: 'する/作る', breakdown: [] },
  ...
  { id: 417, category: '動詞', thai: 'รู้', phonetic: 'Roo', kana: 'ルー', meaning: '知る（知識）', breakdown: [] },
  { id: 418, category: '動詞', thai: 'รู้จัก', phonetic: 'Roo jak', kana: 'ルーチャック', meaning: '知っている（面識）', breakdown: [] },
  ...
  { id: 422, category: '動詞', thai: 'ต้องการ', phonetic: 'Tong kan', kana: 'トンガーン', meaning: '欲しい/必要（丁寧）', breakdown: [] },
  { id: 423, category: '動詞', thai: 'อยาก', phonetic: 'Yak', kana: 'ヤーク', meaning: '〜したい（願望）', breakdown: [] },
  { id: 424, category: '動詞', thai: 'เอา', phonetic: 'Ao', kana: 'アオ', meaning: '要る/取る', breakdown: [] },
  { id: 425, category: '動詞', thai: 'มี', phonetic: 'Mee', kana: 'ミー', meaning: 'ある/持っている', breakdown: [] },
  { id: 426, category: '動詞', thai: 'ไม่มี', phonetic: 'Mai mee', kana: 'マイミー', meaning: 'ない', breakdown: [] },
  { id: 427, category: '動詞', thai: 'ใช่', phonetic: 'Chai', kana: 'チャイ', meaning: 'そうである', breakdown: [] },
  { id: 428, category: '動詞', thai: 'ไม่ใช่', phonetic: 'Mai chai', kana: 'マイチャイ', meaning: 'そうではない', breakdown: [] },
  { id: 429, category: '動詞', thai: 'ช่วย', phonetic: 'Chuay', kana: 'チュアイ', meaning: '助ける/手伝う', breakdown: [] },
  ...
  { id: 446, category: '動詞', thai: 'กลับ', phonetic: 'Klap', kana: 'クラップ', meaning: '帰る/戻る', breakdown: [] },
  { id: 447, category: '動詞', thai: 'ถาม', phonetic: 'Tam', kana: 'ターム', meaning: '聞く（質問）', breakdown: [] },
  { id: 448, category: '動詞', thai: 'ตอบ', phonetic: 'Top', kana: 'トープ', meaning: '答える', breakdown: [] },
  { id: 449, category: '動詞', thai: 'หา', phonetic: 'Ha', kana: 'ハー', meaning: '探す/会う', breakdown: [] },
  { id: 450, category: '動詞', thai: 'พบ', phonetic: 'Pop', kana: 'ポップ', meaning: '会う（発見）', breakdown: [] },
  { id: 451, category: '動詞', thai: 'ใช้', phonetic: 'Chai', kana: 'チャイ', meaning: '使う', breakdown: [] },
  { id: 452, category: '動詞', thai: 'ให้', phonetic: 'Hai', kana: 'ハイ', meaning: 'あげる/〜させる', breakdown: [] },
  ...
  { id: 458, category: '動詞', thai: 'ขี่', phonetic: 'Khee', kana: 'キー', meaning: '乗る（バイクなど）', breakdown: [] },
  ...
  // --- 形容詞 (500-560) ---
  { id: 501, category: '形容詞', thai: 'ร้อน', phonetic: 'Ron', kana: 'ローン', meaning: '暑い/熱い', breakdown: [] },
  { id: 502, category: '形容詞', thai: 'หนาว', phonetic: 'Nao', kana: 'ナーオ', meaning: '寒い（気候）', breakdown: [] },
  { id: 503, category: '形容詞', thai: 'เย็น', phonetic: 'Yen', kana: 'イェン', meaning: '冷たい/涼しい', breakdown: [] },
  ...
  { id: 514, category: '形容詞', thai: 'แพง', phonetic: 'Paeng', kana: 'ペーン', meaning: '高い（値段）', breakdown: [] },
  ...
  { id: 529, category: '形容詞', thai: 'ใกล้', phonetic: 'Klai', kana: 'クライ', meaning: '近い（発音注意）', breakdown: [] },
  { id: 530, category: '形容詞', thai: 'สะอาด', phonetic: 'Sa-at', kana: 'サアート', meaning: '清潔な', breakdown: [] },
  ...
  { id: 538, category: '形容詞', thai: 'ดัง', phonetic: 'Dang', kana: 'ダン', meaning: 'うるさい/音が大きい', breakdown: [] },
  ...
  { id: 541, category: '形容詞', thai: 'เหมือน', phonetic: 'Muean', kana: 'ムアン', meaning: '同じ/似ている', breakdown: [] },
  { id: 542, category: '形容詞', thai: 'ต่าง', phonetic: 'Tang', kana: 'ターン', meaning: '違う', breakdown: [] },
  
  // --- 色 (570-585) ---
  { id: 570, category: '色', thai: 'สี', phonetic: 'See', kana: 'シー', meaning: '色', breakdown: [] },
  { id: 571, category: '色', thai: 'สีแดง', phonetic: 'See daeng', kana: 'シーデーン', meaning: '赤', breakdown: [] },
  { id: 572, category: '色', thai: 'สีน้ำเงิน', phonetic: 'See nam ngoen', kana: 'シーナムグン', meaning: '青（紺）', breakdown: [] },
  { id: 573, category: '色', thai: 'สีฟ้า', phonetic: 'See fa', kana: 'シーファー', meaning: '水色/空色', breakdown: [] },
  { id: 574, category: '色', thai: 'สีเหลือง', phonetic: 'See lueang', kana: 'シー ルアン', meaning: '黄色', breakdown: [] },
  { id: 575, category: '色', thai: 'สีเขียว', phonetic: 'See khiao', kana: 'シーキアオ', meaning: '緑', breakdown: [] },
  { id: 576, category: '色', thai: 'สีขาว', phonetic: 'See khao', kana: 'シーカーオ', meaning: '白', breakdown: [] },
  { id: 577, category: '色', thai: 'สีดำ', phonetic: 'See dam', kana: 'シーダム', meaning: '黒', breakdown: [] },
  { id: 578, category: '色', thai: 'สีชมพู', phonetic: 'See chompoo', kana: 'シーチョンプー', meaning: 'ピンク', breakdown: [] },
  { id: 579, category: '色', thai: 'สีส้ม', phonetic: 'See som', kana: 'シーソム', meaning: 'オレンジ', breakdown: [] },
  { id: 580, category: '色', thai: 'สีม่วง', phonetic: 'See muang', kana: 'シームアン', meaning: '紫', breakdown: [] },
  { id: 581, category: '色', thai: 'สีน้ำตาล', phonetic: 'See nam tan', kana: 'シーナムターン', meaning: '茶色', breakdown: [] },
  { id: 582, category: '色', thai: 'สีเทา', phonetic: 'See tao', kana: 'シータオ', meaning: '灰色', breakdown: [] },
  { id: 583, category: '色', thai: 'สีทอง', phonetic: 'See thong', kana: 'シートーン', meaning: '金', breakdown: [] },
  { id: 584, category: '色', thai: 'สีเงิน', phonetic: 'See ngoen', kana: 'シーグン', meaning: '銀', breakdown: [] },

  // --- 買い物・食事 (600-690) ---
  { id: 601, category: '買い物', thai: 'เท่าไหร่', phonetic: 'Thao rai', kana: 'タオライ？', meaning: 'いくらですか？', breakdown: [] },
  { id: 602, category: '買い物', thai: 'ลดได้ไหม', phonetic: 'Lot dai mai', kana: 'ロットダイマイ？', meaning: 'まけてくれますか？', breakdown: [] },
  ...
  { id: 610, category: '食事', thai: 'ก๋วยเตี๋ยว', phonetic: 'Kuay tiao', kana: 'クイッティアオ', meaning: 'タイ風ラーメン', breakdown: [] },
  { id: 611, category: '食事', thai: 'ผัดไทย', phonetic: 'Pad Thai', kana: 'パッタイ', meaning: 'タイ風焼きそば', breakdown: [] },
  { id: 612, category: '食事', thai: 'ต้มยำกุ้ง', phonetic: 'Tom Yam Kung', kana: 'トムヤムクン', meaning: '海老の辛酸っぱいスープ', breakdown: [] },
  { id: 613, category: '食事', thai: 'ส้มตำ', phonetic: 'Som Tam', kana: 'ソムタム', meaning: 'パパイヤサラダ', breakdown: [] },
  { id: 614, category: '食事', thai: 'ไก่ย่าง', phonetic: 'Gai Yang', kana: 'ガイヤーン', meaning: '焼き鳥', breakdown: [] },
  ...
  { id: 630, category: '買い物', thai: 'กระเป๋า', phonetic: 'Krapao', kana: 'グラパオ', meaning: '鞄/バッグ', breakdown: [] },
  ...
  { id: 633, category: '食事', thai: 'เก็บตังค์', phonetic: 'Kep tang', kana: 'ケップタン', meaning: 'お勘定（カジュアル）', breakdown: [] },
  ...
  { id: 720, category: '日時', thai: 'เมษายน', phonetic: 'Mesayon', kana: 'メーサーヨン', meaning: '4月（ソンクラーン）', breakdown: [] },
  ...
  { id: 723, category: '日時', thai: 'ชั่วโมง', phonetic: 'Chua mong', kana: 'チュアモーン', meaning: '時間（Count）', breakdown: [] },
  ...
  { id: 819, category: '場所', thai: 'เซเว่น', phonetic: 'Seven', kana: 'セウェン', meaning: 'セブンイレブン', breakdown: [] },
  ...
  { id: 859, category: '緊急', thai: 'หาย', phonetic: 'Hai', kana: 'ハーイ', meaning: '無くした/消えた', breakdown: [] },
  ...
  { id: 862, category: '緊急', thai: 'หลงทาง', phonetic: 'Long thang', kana: 'ロンターン', meaning: '道に迷った', breakdown: [] },
  ...
  { id: 912, category: '体', thai: 'เท้า', phonetic: 'Thao', kana: 'タオ', meaning: '足（くるぶし以下）', breakdown: [] },
  ...
  { id: 919, category: 'モノ', thai: 'โทรศัพท์', phonetic: 'Torasap', kana: 'トーラサップ', meaning: '電話/スマホ', breakdown: [] },
  { id: 920, category: 'モノ', thai: 'หนังสือ', phonetic: 'Nang sue', kana: 'ナンスー', meaning: '本', breakdown: [] },
  { id: 921, category: 'マインド', thai: 'ไม่เป็นไร', phonetic: 'Mai pen rai', kana: 'マイペンライ', meaning: '気にしない/大丈夫', breakdown: [] },
  ...
  { id: 927, category: 'マインド', thai: 'น่าสนใจ', phonetic: 'Na son jai', kana: 'ナーソンジャイ', meaning: '面白い/興味深い', breakdown: [] },
...
export default function App() {
  ...
  const handleModeSelect = (mode) => {
    setTargetTab(mode);
    // 会話モードの場合はカテゴリ選択をスキップして直接一覧へ（カテゴリ分けも可能だが今回は全リスト表示）
